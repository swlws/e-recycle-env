...
echo "应用数据库用户: swlws"
echo "请使用以下命令测试连接："
echo "管理员连接: mongosh --host 127.0.0.1:27017 --username admin --password 'admin@XXXX' --authenticationDatabase admin"
echo "应用用户连接: mongosh --host 127.0.0.1:27017 --username swlws --password 'swlws@XXXX' --authenticationDatabase swlws"